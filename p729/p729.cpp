...
int main(int argc, char *argv[])
{
    ...
    function = sin_x2;      // function
    double a = 0;           // interval a
    double b = 10;          // interval b
    ...
    num = arb_calc_isolate_roots(&blocks, &info, function, params, interval, maxdepth, maxeval, maxfound, low_prec);
