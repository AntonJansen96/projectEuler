...
// void G(arb_t res, const arb_t x, int P, slong prec)
// {
//     arb_t fx, temp;
//     arb_init(fx);
//     arb_init(temp);
//     arb_set(fx, x);
//     for (int i = 0; i < P; i++) {
//         arb_inv(temp, fx, prec);
//         arb_sub(fx, fx, temp, prec);
//     }
//     arb_sub(res, fx, x, prec);
//     arb_clear(fx);
//     arb_clear(temp);
// }

// int G_callback(arb_t res, const arb_t x, void *param, slong order, slong prec)
// {
//     int P = *(int *)param;
//     G(res, x, P, prec);
//     return 0;
...
// void arf_interval_set_endpoints(arf_interval_t interval, const arf_t left, const arf_t right)
// {
//     arf_set(&interval->a, left);
//     arf_set(&interval->b, right);
// }
...
//     int P = 3;
//     slong prec = 256;
//     double x_min = -7.0, x_max = 7.0, dx = 0.01;
...
//     arf_t start_lo, start_hi, end_lo, end_hi;
//     arf_init(start_lo);
//     arf_init(start_hi);
//     arf_init(end_lo);
//     arf_init(end_hi);

//     arf_interval_t root, start, end;
//     arf_interval_init(root);
//     arf_interval_init(start);
//     arf_interval_init(end);
...
//         if (arf_cmp_si(arb_midref(y0), 0) * arf_cmp_si(arb_midref(y1), 0) < 0)
//         {
//             arb_get_interval_arf(start_lo, start_hi, x0, prec);
//             arb_get_interval_arf(end_lo, end_hi, x1, prec);

//             arf_interval_set_endpoints(start, start_lo, start_hi);
//             arf_interval_set_endpoints(end, end_lo, end_hi);

//             arb_calc_refine_root_bisect(root, G_callback, &P, start, 10, prec);

//             arf_interval_printd(root, 30);
//             printf("\n");
//         }
//     }
...
//     arf_clear(end_lo);
//     arf_clear(end_hi);
//     arf_interval_clear(root);
//     arf_interval_clear(start);
//     arf_interval_clear(end);
// }
